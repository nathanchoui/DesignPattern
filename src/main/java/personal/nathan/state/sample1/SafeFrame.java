...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private Button buttonUse = new Button("Use Coffer");      // 金库使用按钮
    private Button buttonAlarm = new Button("Press alarm");    // 按下警铃按钮
    private Button buttonPhone = new Button("Common Communication");    // 正常通话按钮
